...
export default function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center px-8 md:px-16 py-6 fixed w-full top-0 z-[100] backdrop-blur-md border-b border-white/10 bg-black/30">
      <Link href="/" className="font-[var(--font-orbitron)] font-black text-3xl tracking-widest text-white flex items-center gap-2 z-50">
